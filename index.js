...
function loadOnClickFunctions() {
    document.getElementById("addTimezoneButton").addEventListener("click", openForm);
    document.getElementById("confirmTimezoneSelectionButton").addEventListener("click", addTimezoneCard);
    document.getElementById("cancelTimezoneButton").addEventListener("click", closeForm);
    document.getElementById("resetTimezoneButton").addEventListener("click", resetTime);
}
